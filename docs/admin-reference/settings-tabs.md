...
Create and manage sales schedules. Assign products/variations, set sale prices, choose date windows. Saving syncs WooCommerce prices and can link banners. Enable/disable in Settings.
...
- **Tab gating**: Enable/disable Schedule and Banners tabs

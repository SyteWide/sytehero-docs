...
sidebar_position: 3
title: Elementor
description: How to set up SyteSlyders with Elementor and Flexbox Containers.
---
...
2. In the widget's **Advanced** tab, add the CSS class `slyders-hero-text-area-1` to use it as the primary headline.
3. For a secondary tagline, add another Heading widget with the class `slyders-hero-text-area-2`.

### CTA Button

1. Add a **Button** widget in the same container.
2. In the widget's **Advanced** tab, add the CSS class `slyders-hero-cta`.
